...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Ubuntu 4.8.4-2ubuntu1~14.04) 4.8.4'
...
grub_target_cppflags=' -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/i686-linux-gnu/4.8/include'
